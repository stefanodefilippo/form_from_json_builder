          ...
          return Column(
            children: [
              Container(
                ...
                child: formModel!.title != null ? Text(
                  formModel!.title!,
        ...
        MaterialButton(
          onPressed: (){
            if(widget.onSubmit != null) {
              widget.onSubmit!(Provider.of<FormStateNotifier>(context, listen: false).formValues);
            }
          },
          shape: widget.submitButtonShapeBorder,
          color: widget.submitButtonColor,
          child: formModel.submitButtonTitle != null ? Text(
